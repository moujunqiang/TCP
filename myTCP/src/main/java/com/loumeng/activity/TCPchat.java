...
public class TCPchat extends Activity {
    ...
    //    private final static String FILE_NAME = "xth.txt";
    //控件按钮
...
//    private String SP_DATE="sp_date";
//    private int flag=1;
...
//            }
//        }else {
//            Toast.makeText(TCPchat.this,"创建成功！",Toast.LENGTH_SHORT).show();
//        }
//        file.delete();//删除文件
...
//       conserve.setOnClickListener(conservelistener);
    ...
    private void init() {
        ...
        findViewById(R.id.de_history).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(TCPchat.this,HistoryActivity.class));
            }
        });

//        conserve = (Button) findViewById(R.id.de_conserve);
    ...
    private View.OnClickListener conservelistener = new View.OnClickListener() {
        @Override
...
//       //实例化实例化SharedPreferences的编辑者对象
//       SharedPreferences.Editor editor = sharedPreferences.edit();
//      //存储数据
//       editor.putString(SP_DATE, re_data_show.getText().toString());
//      //提交
//      editor.commit();
//
//   }
    ...
    private void Handler_receive(Message msg) {
        ...
        if (Hex_show == true) {
            ...
            StringBuilder stringBuilder = new StringBuilder(history);
            stringBuilder.append(re_data_show.getText().toString() + ",");
            data.edit().putString("history", stringBuilder.toString()).commit();
